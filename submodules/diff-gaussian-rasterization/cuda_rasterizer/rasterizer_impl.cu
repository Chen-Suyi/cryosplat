...
__global__ void checkCuboid(int P,
	...
	bool* present)
{
	...
	float3 p_view;
	present[idx] = in_cuboid(idx, orig_points, viewmatrix, projmatrix, false, p_view);
}
...
CudaRasterizer::GeometryState CudaRasterizer::GeometryState::fromChunk(char*& chunk, size_t P)
{
	...
	obtain(chunk, geom.conic_amplitude, P, 128);
